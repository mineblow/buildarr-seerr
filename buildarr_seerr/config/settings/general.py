...
"""Seerr plugin general settings configuration."""
...
class SeerrGeneralSettings(SeerrConfigBase):
    """
    These settings adjust the general behaviour for how Seerr
    ...
    application_title: NonEmptyStr = "Seerr"  # type: ignore[assignment]
    """
    Name of the Seerr instance, as shown in the browser title.
    """

    application_url: Optional[AnyHttpUrl] = None
    """
    Application URL to use when generating links to Seerr.

    If set to `null`, use the URL the browser is currently using to access Seerr.
    """
    ...
    When this attribute is changed, a restart of Seerr is required.
    """
    ...
    """
    The display language of the Seerr UI.
